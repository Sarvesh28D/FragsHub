                ...
                >
                  <div className="flex justify-between items-center">
                    ...
                    <motion.button
                      type="button"
                      onClick={addPlayer}
                      className="flex items-center space-x-2 bg-gradient-to-r from-green-500 to-emerald-600 px-4 py-2 rounded-lg text-white font-semibold"
                      whileHover={{ scale: 1.05 }}
                      whileTap={{ scale: 0.95 }}
                      ...
                      >
                        ...
                        {teamData.players.length > 4 && (
                          <motion.button
                            ...
                            className="p-3 bg-red-500/20 border border-red-500/30 rounded-xl text-red-400 hover:bg-red-500/30 transition-all duration-300"
              ...
              <div className="ml-auto">
                {currentStep < 3 ? (
                  <motion.button
                    type="button"
                    onClick={() => setCurrentStep(currentStep + 1)}
                    className="px-8 py-4 bg-gradient-to-r from-cyan-500 to-purple-600 rounded-xl text-white font-semibold"
                  ...
                  <motion.button
                    ...
                    className="px-12 py-4 bg-gradient-to-r from-green-500 to-emerald-600 rounded-xl text-white font-bold disabled:opacity-50 disabled:cursor-not-allowed"
