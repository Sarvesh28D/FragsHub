...
exports.generateTournamentBracketsHandler = exports.cleanupExpiredPaymentsHandler = void 0;
const admin = __importStar(require("firebase-admin"));
const axios_1 = __importDefault(require("axios"));
// Get firestore instance
const getDB = () => admin.firestore();
// Handler to cleanup expired payments (runs every hour)
const cleanupExpiredPaymentsHandler = async () => {
    try {
...
exports.cleanupExpiredPaymentsHandler = cleanupExpiredPaymentsHandler;
// Handler to generate tournament brackets (runs daily at 9 AM)
const generateTournamentBracketsHandler = async () => {
    try {
        ...
        for (const tournamentDoc of tournamentsQuery.docs) {
            ...
            try {
                ...
                const challongeResponse = await axios_1.default.post('https://api.challonge.com/v1/tournaments.json', {
                ...
                for (const participant of participants) {
                    await axios_1.default.post(`https://api.challonge.com/v1/tournaments/${challongeTournament.id}/participants.json`, {
                        api_key: challongeApiKey,
                        participant: participant
                    });
                }
                // Start the tournament (generate brackets)
                await axios_1.default.post(`https://api.challonge.com/v1/tournaments/${challongeTournament.id}/start.json`, {
                    api_key: challongeApiKey
                });
...
exports.generateTournamentBracketsHandler = generateTournamentBracketsHandler;
